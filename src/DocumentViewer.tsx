...
export default function DocumentViewer({ document, className, onExpandSection }: DocumentViewerProps) {
    ...
    return (
        <div className={classNames}>
            ...
            <ContentElements contentElements={document.contentElements} onExpandSection={onExpandSection} isTopLevel />
        </div>
    );
}
